	...
	<blockquote class="layui-elem-quote quoteBox">
		<form class="layui-form">
			<div class="layui-inline">
				<a href="${pageContext.request.contextPath }/Jurisdictions/role/role" style="background: #009688;" class="layui-btn layui-btn-normal addNews_btn">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/roleList.js?time="></script>
</body>
</html>