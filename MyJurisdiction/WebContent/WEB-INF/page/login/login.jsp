                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                           		<form role="form" class="login-form" action="${pageContext.request.contextPath }/login/verification" method="POST">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">Username</label>
			                        	<input type="text" placeholder="Username..." class="form-username form-control" id="name" name="name" value="${name }">
			                        </div>
			                        <div class="form-group">
			                        ...
			                        <div class="form-group" id="imgCode">
										<input type="text" placeholder="请输入验证码" style="width:252px;" autocomplete="off" id="code" name="codes" class="layui-input">
										<img id="codes" style="border-radius:5px;" src="${pageContext.request.contextPath }/code">
									</div>
