...
<form:form method="POST" id="forms" action="${pageContext.request.contextPath }/Jurisdictions/user/user" target="_self" modelAttribute="user" >
	<form:hidden path="id"/>
	<div class="layui-col-md3 layui-col-xs12 user_right">
		<div class="layui-upload-list">
			<c:if test="${user.headUrl == null}"><!-- 这里表示是添加页面,对象的值为空	587c589d26802.jpg默认头像 -->
				<img src="${pageContext.request.contextPath }/images/587c589d26802.jpg" class="layui-upload-img layui-circle userFaceBtn userAvatar" id="userFace">
				<input type="hidden" id="filesCopy" name="filesCopy" value="E:/workspace/MyJurisdiction/WebContent/images/587c589d26802.jpg"><!-- 如果是添加页面,头像value的值是默认的图片,隐藏框是存图片路径 -->
			</c:if>
			<c:if test="${user.headUrl != null}">
				<input type="hidden" name="_method" value="PUT">
				<img src="${pageContext.request.contextPath }/Jurisdictions/user/icons/${user.id}" class="layui-upload-img layui-circle userFaceBtn userAvatar" id="userFace">
				<input type="hidden" id="filesCopy" name="filesCopy" value="${user.headUrl }"><!-- 隐藏框是存图片路径 -->
			</c:if>
		</div>
	...
	<div class="layui-col-md6 layui-col-xs12">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<form:input path="name" placeholder="请输入用户名" disabled="disabled" class="layui-input"/>
			</div>
		</div>
		<c:if test="${user.headUrl == null}">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<%-- <form:input path="name" disabled="disabled" class="layui-input layui-disabled" /> --%>
					<form:input type="password" path="passwd" placeholder="请输入密码" disabled="disabled" class="layui-input"/>
				</div>
			</div>
		</c:if>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<form:input path="empno" placeholder="请输入工号" disabled="disabled" class="layui-input"/>
			</div>
		</div>
		<!-- <div class="layui-form-item">
