...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
		...
		var _this = this;
		var sss = $("#sss").val();
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="page/main.html"><i class="layui-icon" data-icon=""></i><cite>'+sss+'</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);
